...
public sealed partial class CrewMemberEntry : PanelContainer
{
    ...
    private void SetupStyles()
    {
        ...
        SquadDropdown.AddStyleClass(SecTrackStyles.StyleClassOptionButton);
        SquadDropdown.OptionStyleClasses.Add(SecTrackStyles.StyleClassButtonRed);

        MemberNameLabel.FontColorOverride = SecTrackStyles.HeadingColor;
        JobTitleLabel.FontColorOverride = SecTrackStyles.SubTextColor;
    }
