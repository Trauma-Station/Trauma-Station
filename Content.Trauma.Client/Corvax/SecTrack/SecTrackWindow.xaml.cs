...
public sealed partial class SecTrackWindow : BaseWindow
{
    ...
    public SecTrackWindow()
    {
        ...
        _styles = new SecTrackStyles(_resCache);
    ...
    {
        StationLabel.FontColorOverride = SecTrackStyles.HeadingColor;
        StationLabel.FontOverride = _styles.GetBoldFont(16);

        UnassignedCountLabel.FontColorOverride = SecTrackStyles.TextColor;
        UnassignedCountLabel.FontOverride = _styles.GetRegularFont(13);

        SquadsCountLabel.FontColorOverride = SecTrackStyles.TextColor;
        SquadsCountLabel.FontOverride = _styles.GetRegularFont(13);

        Footer.FontColorOverride = SecTrackStyles.SubTextColor;
        Footer.FontOverride = _styles.GetRegularFont(11);

        StationLabel.AddStyleClass(SecTrackStyles.StyleClassConsoleHeading);
        NewSquadName.AddStyleClass(SecTrackStyles.StyleClassConsoleLineEdit);
        CreateSquadButton.AddStyleClass(SecTrackStyles.StyleClassButtonRed);

        var buttonStyleRule = SecTrackStyles.CreateButtonRedRule(
            _styles.GetButtonRedStyle(),
            _styles.GetBoldFont(11),
            SecTrackStyles.TabActiveColor,
            SecTrackStyles.TabInactiveColor
        );

        var lineEditRule = SecTrackStyles.CreateLineEditRule(
            _styles.GetLineEditStyle(),
            _styles.GetRegularFont(11),
            SecTrackStyles.TextColor,
            SecTrackStyles.PlaceholderColor
        );

        var optionRule = SecTrackStyles.CreateOptionButtonRule(
        ...
        var optionBackgroundRule = SecTrackStyles.CreateOptionButtonBackgroundRule();
    ...
    private void SetupTabContainer()
    {
        ...
        Tabs.TabFontColorOverride = SecTrackStyles.TabActiveColor;
        Tabs.TabFontColorInactiveOverride = SecTrackStyles.TabInactiveColor;

        var tabRule = SecTrackStyles.CreateTabContainerRule(
