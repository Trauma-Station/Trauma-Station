...
public sealed partial class SquadEntry : PanelContainer
{
    ...
    public SquadEntry(Squad squad, SecTrackStyles styles, IPrototypeManager protoMan, SpriteSystem sprite)
    {
    ...
    private void SetupStyles()
    {
        PanelOverride = new StyleBoxFlat
        {
            ...
            BorderColor = SecTrackStyles.TabActiveColor,
        ...
        RenameButton.AddStyleClass(SecTrackStyles.StyleClassButtonRed);
        DeleteButton.AddStyleClass(SecTrackStyles.StyleClassButtonRed);
        EditDescriptionButton.AddStyleClass(SecTrackStyles.StyleClassButtonRed);
        SaveDescriptionButton.AddStyleClass(SecTrackStyles.StyleClassButtonRed);
        SaveNameButton.AddStyleClass(SecTrackStyles.StyleClassButtonRed);

        SquadNameEdit.AddStyleClass(SecTrackStyles.StyleClassConsoleLineEdit);
        SquadDescriptionEdit.AddStyleClass(SecTrackStyles.StyleClassConsoleLineEdit);

        IconDropdown.AddStyleClass(SecTrackStyles.StyleClassOptionButton);
        StatusDropdown.AddStyleClass(SecTrackStyles.StyleClassOptionButton);

        IconDropdown.OptionStyleClasses.Add(SecTrackStyles.StyleClassButtonRed);
        StatusDropdown.OptionStyleClasses.Add(SecTrackStyles.StyleClassButtonRed);

        SquadNameLabel.FontColorOverride = SecTrackStyles.HeadingColor;
        MembersCountLabel.FontColorOverride = SecTrackStyles.TextColor;
        MembersHeaderLabel.FontColorOverride = SecTrackStyles.SubHeadingColor;
    }
    ...
    private void UpdateUI()
    {
        ...
        SquadLocationLabel.FontColorOverride = SecTrackStyles.TabInactiveColor;
    ...
    private void UpdateMembersList()
    {
        ...
        if (Squad.Members.Count == 0)
        {
            var emptyLabel = new Label
            {
                ...
                FontColorOverride = SecTrackStyles.TabInactiveColor,
    ...
    private PanelContainer CreateMemberEntry(CrewMemberInfo member)
    {
        ...
        var jobLabel = new Label
        {
            ...
            FontColorOverride = SecTrackStyles.SubTextColor,
        ...
        removeButton.AddStyleClass(SecTrackStyles.StyleClassButtonRed);
    ...
    private void UpdateSquadLocation((string Location, bool HasLocation) locationInfo)
    {
        if (locationInfo.HasLocation && !string.IsNullOrWhiteSpace(locationInfo.Location))
        {
            ...
            SquadLocationLabel.FontColorOverride = SecTrackStyles.TextColor;
        }
        else
        {
            SquadLocationLabel.Text = Loc.GetString("sec-track-unknown");
