...
using Content._Trauma.Shared.CosmicCult.Prototypes;
using Robust.Client.UserInterface;
using Robust.Client.Player;
using Robust.Shared.Prototypes;

namespace Content._Trauma.Client.CosmicCult.UI.CosmicShop;
...
public sealed class CosmicShopBoundUserInterface(EntityUid owner, Enum uiKey) : BoundUserInterface(owner, uiKey)
{
    ...
    protected override void UpdateState(BoundUserInterfaceState state)
    {
        ...
        || !_entMan.TryGetComponent<CosmicCultistComponent>(_player.LocalEntity, out var comp))
            return;
