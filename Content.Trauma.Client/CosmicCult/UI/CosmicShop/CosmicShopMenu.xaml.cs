...
public sealed partial class CosmicShopMenu : FancyWindow
{
    ...
    public void UpdateState(CosmicCultistComponent state)
    {
        UpdateBar(state);
        UpdateEntropy(state);
    ...
    /// </summary>
    private void UpdateBar(CosmicCultistComponent state)
    {
    ...
    /// </summary>
    private void UpdateEntropy(CosmicCultistComponent state)
    {
    ...
    /// </summary>
    private void UpdateInfluences(CosmicCultistComponent state)
    {
    ...
    private void UpdateLevelupConfirmation(CosmicCultistComponent state)
    {
    ...
    /// </summary>
    private void OpenInfluenceDetails(InfluencePrototype influenceProto, CosmicCultistComponent state)
    {
    ...
    private InfluenceUIBox.InfluenceUIBoxState GetUIBoxStateForInfluence(InfluencePrototype influence, CosmicCultistComponent state)
    {
