...
public sealed partial class CrewMemberEntry : PanelContainer
{
    ...
    private void SetupStyles()
    {
        ...
        SquadDropdown.AddStyleClass(SecTrackSheetlet.StyleClassOptionButton);
        SquadDropdown.OptionStyleClasses.Add(SecTrackSheetlet.StyleClassButtonRed);

        MemberNameLabel.FontColorOverride = SecTrackSheetlet.TabActiveColor;
        JobTitleLabel.FontColorOverride = SecTrackSheetlet.TabInactiveColor;
    }
    ...
    private void UpdateSquadDropdown()
    {
        ...
        if (!Squads.Any())
        {
            SquadDropdown.AddItem(Loc.GetString("sec-track-assign-no-squads"));
            SquadDropdown.Disabled = true;
            return;
        }

        SquadDropdown.Disabled = false;
        SquadDropdown.AddItem(Loc.GetString("sec-track-assign-select-squad"));
