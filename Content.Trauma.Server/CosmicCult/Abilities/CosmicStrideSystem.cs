...
public sealed class CosmicStrideSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<CosmicCultistComponent, EventCosmicStride>(OnCosmicImposition);
    }
    ...
    private void OnCosmicImposition(Entity<CosmicCultistComponent> uid, ref EventCosmicStride args)
    {
