...
public sealed class CosmicMonumentSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<CosmicCultistComponent, EventCosmicPlaceMonument>(OnCosmicPlaceMonument);
    ...
    private void OnCosmicPlaceMonument(Entity<CosmicCultistComponent> ent, ref EventCosmicPlaceMonument args)
    {
        if (!TryComp<MonumentPlacementActionComponent>(args.Action, out var monuPlacement)
        || !TryComp<CosmicCultistComponent>(args.Performer, out var cultComp)
    ...
    /// </summary>
    private void ToggleMarkApproval(Entity<MonumentSpawnMarkComponent> monument, Entity<CosmicCultistComponent> cultist)
    {
    ...
    {
        var cultQuery = EntityQueryEnumerator<CosmicCultistComponent>();
    ...
    {
        if (!TryComp<CosmicCultistComponent>(args.User, out var cultComp)) return;
    ...
    private bool VerifyPlacement(Entity<CosmicCultistComponent> uid, out EntityCoordinates outPos)
    {
