...
public sealed class CosmicBlankSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<CosmicCultistComponent, EventCosmicBlank>(OnCosmicBlank);
        SubscribeLocalEvent<CosmicCultistComponent, EventCosmicBlankDoAfter>(OnCosmicBlankDoAfter);
    }

    private void OnCosmicBlank(Entity<CosmicCultistComponent> uid, ref EventCosmicBlank args)
    {
    ...
    private void OnCosmicBlankDoAfter(Entity<CosmicCultistComponent> uid, ref EventCosmicBlankDoAfter args)
    {
