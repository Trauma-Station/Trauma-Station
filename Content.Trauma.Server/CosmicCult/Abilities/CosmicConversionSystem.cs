...
public sealed class CosmicConversionSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<CosmicCultistComponent, EventCosmicConversion>(OnCosmicConversion);
        SubscribeLocalEvent<CosmicCultistComponent, CosmicConversionDoAfter>(OnDoAfter);
    }

    private void OnCosmicConversion(Entity<CosmicCultistComponent> ent, ref EventCosmicConversion args)
    {
    ...
    private void OnDoAfter(Entity<CosmicCultistComponent> ent, ref CosmicConversionDoAfter args)
    {
