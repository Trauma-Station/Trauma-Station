...
public sealed class CosmicCultRuleSystem : GameRuleSystem<CosmicCultRuleComponent>
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<CosmicCultistComponent, ComponentShutdown>(OnComponentShutdown);
    ...
    public void UpdateCultData(Entity<CosmicCultistComponent> ent)
    {
    ...
    private void UpdateCultData(Entity<CosmicCultRuleComponent> rule)
    {
        ...
        {
            if (!TryComp<CosmicCultistComponent>(cultist, out var comp)) return;
    ...
    {
        var query = EntityQueryEnumerator<CosmicCultistComponent, MobStateComponent>();
    ...
    private void ConfirmWinState(Entity<CosmicCultRuleComponent> ent)
    {
        ...
        var wrapup = AllEntityQuery<CosmicCultistComponent, TransformComponent>();
    ...
    public void IncrementCultObjectiveEntropy(Entity<CosmicCultistComponent> ent, int amount)
    {
    ...
    private void OnComponentShutdown(Entity<CosmicCultistComponent> ent, ref ComponentShutdown args)
    {
        if (AssociatedGamerule(ent) is not { } cult)
            return;
