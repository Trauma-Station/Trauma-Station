...
public sealed partial class CosmicCultSystem : SharedCosmicCultSystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<CosmicCultistComponent, GetVisMaskEvent>(OnGetVisMask);
    ...
    public override int AddEntropy(Entity<CosmicCultistComponent> ent, int amount)
    {
    ...
    public override void LevelUp(Entity<CosmicCultistComponent> ent)
    {
        base.LevelUp(ent);
    ...
    public override void OnLevelUpConfirmed(Entity<CosmicShopComponent> ent, ref LevelUpconfirmedMessage args)
    {
        ...
        if (!TryComp<CosmicCultistComponent>(args.Actor, out var cultComp)) return;
    ...
    /// </summary>
    private void OnStartCultist(Entity<CosmicCultistComponent> uid, ref ComponentInit args)
    {
    ...
    private void OnGetVisMask(Entity<CosmicCultistComponent> uid, ref GetVisMaskEvent args)
    {
