...
/// <summary>
///     Connects with other <see cref="PlumbingNode"/>s whose <see cref="PipeDirection"/>
///     and <see cref="CurrentPipeLayer"/> correctly correspond.
/// </summary>
[DataDefinition]
[Virtual]
public partial class PlumbingNode : Node, ISolutionMixtureHolder, IRotatableNode
{
    /// <summary>
    ...
    public void RemoveAlwaysReachable(PlumbingNode pipeNode)
    {
    ...
    /// </summary>
    [ViewVariables]
    public Solution Liquid
    {
        get => PipeNet?.Liquid ?? new Solution();
        set
        {
            if (PipeNet == null)
                return;

            PipeNet.Liquid = value;
        }
    }
