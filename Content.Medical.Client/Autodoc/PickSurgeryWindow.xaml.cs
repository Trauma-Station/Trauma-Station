...
public sealed partial class PickSurgeryWindow : FancyWindow
{
    ...
    private ProtoId<SurgeryPrototype>? _surgeryId;
    ...
    public PickSurgeryWindow()
    {
        ...
        {
            if (Surgeries[args.ItemIndex].Metadata is not ProtoId<SurgeryPrototype> id)
                return;
    ...
    private void UpdateSurgeries()
    {
        ...
        foreach (var id in _proto.EnumeratePrototypes<SurgeryPrototype>())
        {
            Surgeries.AddItem(id.ID, metadata: id);
        }
