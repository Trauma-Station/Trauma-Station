...
# Emergency shuttle
emergency-shuttle-left = The Emergency Shuttle has left the station. Estimate {$transitTime} seconds until the shuttle arrives at Outer Heaven.
...
# Map Misc.
map-name-centcomm = Outer Heaven
