...
## trauma edit start - replacing nuke codes with cburn
blob-alert-critical = Biohazard level critical, a specialized response force has been dispatched to your sector.
### trauma edit end
