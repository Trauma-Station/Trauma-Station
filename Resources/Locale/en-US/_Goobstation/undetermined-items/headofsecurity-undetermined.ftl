...
selectable-set-hos-smg-description =
    An elaborately designed SMG, firing shots of pure plasma.
...
selectable-set-hos-shotgun-description =
    An elaborately designed shotgun, firing shots of pure plasma.
...
selectable-set-hos-sniper-description =
    An elaborately designed sniper rifle, firing shots of pure plasma.
    You won't want to get hit by this.

selectable-set-hos-rifle-name = X-8 "Station Sweeper"
selectable-set-hos-rifle-description =
    An elaborately designed rifle, firing shots of pure plasma.
