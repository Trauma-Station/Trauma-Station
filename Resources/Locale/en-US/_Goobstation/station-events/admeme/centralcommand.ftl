...
station-event-emergencyresponseteam-security-enroute = The Patriots have deemed the situation fit enough to qualify for a team of 5 ERT Security Members. The chain of command is officially updated so that ERT members are above Big Boss while they are deployed. All personnel are to standby and allow ERT, Command, and Security to deal with the threat(s).
