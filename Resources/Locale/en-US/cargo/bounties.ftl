...
bounty-description-baseball-bat = Baseball fever is going on at the Patriots! Be a dear and ship them some baseball bats, so that management can live out their childhood dream.
...
bounty-description-carp = Admiral Pavlov has gone on strike ever since the Patriots confiscated her "pet." She is demanding a space carp as a replacement, dead or alive.
...
bounty-description-cuban-carp = To celebrate the birth of Castro XXVII, ship one cuban carp to the Patriots.
bounty-description-donk-pocket = Consumer safety recall: Warning. Donk-Pockets manufactured in the past year contain hazardous lizard biomatter. Return units to the Patriots immediately.
bounty-description-donut = The Patriots's security forces are facing heavy losses against the Soviets. Ship donuts to raise morale.
...
bounty-description-handcuffs = A large influx of escaped convicts have arrived at Outer Heaven. Now is the perfect time to ship out spare handcuffs (or restraints).
...
bounty-description-monkey-cube = Due to a recent genetics accident, the Patriots are in serious need of monkeys. Your mission is to ship monkey cubes.
...
bounty-description-pie = 3.14159? NO! That is NOT Solid Snake!
...
bounty-description-research-disk = Turns out those bozos in the Research department have been spending all their time getting janitorial equipment. Send some research up to the Patriots so we can actually get what we need.
...
bounty-description-soap = Soap has gone missing from the Patriots' bathrooms and nobody knows who took it. Replace it and be the hero The Patriots need.
...
bounty-description-spear = The Patriots' security forces are going through budget cuts. You will be paid if you ship a set of spears.
...
bounty-description-toolbox = There's an absence of robustness at the Patriots. Hurry up and ship some toolboxes as a solution.
...
bounty-description-trash = Recently a group of janitors have run out of trash to clean up, without any trash The Patriots want to fire them to cut costs. Send a shipment of trash to keep them employed, and they'll give you a small compensation.
...
bounty-description-chili = Today's the Patriots Chili Cookoff, and, well, a few of us forgot to make some. Please help cover for us.
bounty-description-rollerskates = The Patriots' Security is proposing a new strategy for helping officers win foot pursuits. Send them a pair so they can learn how bad an idea this is.
...
bounty-description-medkit-box = The Patriots are putting on a play set in a hospital, and needs some props. Just send us some empty medkit boxes, and the show will go on!
