...
tips-dataset-30 = As a Soviet agent, you may sometimes be assigned to hunt other agents, and in turn be hunted by others.
...
tips-dataset-63 = As the Chef, you can sneak liquids into your foods. As a Soviet agent, putting a little bit of amatoxin or other poison can greatly annoy the crew!
...
tips-dataset-68 = As the Interrogator, you can chase criminals more effectively by using fingerprint fiber data and DNA obtained from forensic scans of objects the perpetrator likely interacted with.
