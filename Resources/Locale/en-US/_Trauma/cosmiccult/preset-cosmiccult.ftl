...
cosmiccult-finale-warning = All station crew. The Noöspheric anomaly is going supercritical, instruments failing; Noöspheric-to-real transitional event horizon IMMINENT. If you are not already on counter-protocol, immediately sortie and intervene. Repeat: Intervene immediately or die.
...
cosmiccult-summary-crewwin = Crew has survived the efforts of the cosmic cult!
...
cosmiccult-gear-pickup = You pick up {THE($ITEM)}... but somehow, you did not.
