...
petting-success-beepsky = You pet {THE($target)} on {POSS-ADJ($target)} cold metal head.
...
petting-failure-beepsky = You reach out to pet {THE($target)}, but {POSS-ADJ($target)} {CONJUGATE-BE($target)} busy serving justice!
