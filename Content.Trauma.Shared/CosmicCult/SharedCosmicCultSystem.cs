...
public abstract class SharedCosmicCultSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<CosmicCultistComponent, UserShouldTakeHolyEvent>(OnShouldTakeHoly);
    }

    private void OnShouldTakeHoly(Entity<CosmicCultistComponent> ent, ref UserShouldTakeHolyEvent args)
    {
    ...
    private void OnUseInHand(Entity<CosmicEntropyMoteComponent> ent, ref UseInHandEvent args)
    {
        ...
        {
            if (!TryComp<CosmicCultistComponent>(args.User, out var cultComp)) // Only the cultists can absorb entropy
            {
    ...
    {
        return HasComp<CosmicCultistComponent>(ent)
    ...
    public bool UnlockInfluence(Entity<CosmicCultistComponent> ent, ProtoId<InfluencePrototype> influence, bool force = false)
    {
    ...
    /// </summary>
    public virtual int AddEntropy(Entity<CosmicCultistComponent> ent, int amount)
    {
    ...
    private void TryLevelUp(Entity<CosmicCultistComponent> ent)
    {
    ...
    public virtual void LevelUp(Entity<CosmicCultistComponent> ent)
    {
    ...
    {
        if (!TryComp<CosmicCultistComponent>(args.Actor, out var cultComp)
