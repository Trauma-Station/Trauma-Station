...
public abstract class SharedCosmicSiphonSystem : EntitySystem
{
    ...
    private void OnCosmicSiphon(Entity<CosmicCultistComponent> ent, ref EventCosmicSiphon args)
    {
    ...
    protected virtual void OnCosmicSiphonDoAfter(Entity<CosmicCultistComponent> ent, ref EventCosmicSiphonDoAfter args)
    {
        // TODO: kill all of this probably
        /*
