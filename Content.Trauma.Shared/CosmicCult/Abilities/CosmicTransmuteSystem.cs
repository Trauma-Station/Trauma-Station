...
public sealed class CosmicTransmuteSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<CosmicCultistComponent, EventCosmicTransmutation>(OnTransmute);
    ...
    private void OnTransmute(Entity<CosmicCultistComponent> ent, ref EventCosmicTransmutation args)
    {
        if (args.Handled)
            return;
        _message = null;
    ...
    private bool TryTransmutePulled(Entity<CosmicCultistComponent> ent)
    {
    ...
    private bool TryTransmuteHeld(Entity<CosmicCultistComponent> ent)
    {
