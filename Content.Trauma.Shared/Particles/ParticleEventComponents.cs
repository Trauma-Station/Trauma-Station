...
public abstract partial class ParticleOnEventBase : Component
{
    ...
    /// <summary>
    /// Optional color tint applied to the spawned particles.
    /// </summary>
    [DataField]
...
/// <summary>
/// Spawns a particle effect when this entity is used in-hand (e.g. flashlight toggle).
/// </summary>
[RegisterComponent]
public sealed partial class ParticleOnUseComponent : ParticleOnEventBase;

/// <summary>
/// Spawns a particle effect when this entity is used on a target in the world.
/// </summary>
[RegisterComponent]
public sealed partial class ParticleOnUseInWorldComponent : ParticleOnEventBase;

/// <summary>
/// Spawns a particle effect on the attacker when this entity attacks with melee.
/// </summary>
[RegisterComponent]
public sealed partial class ParticleOnMeleeAttackComponent : ParticleOnEventBase;

/// <summary>
/// Spawns a particle effect on each entity hit by a melee attack with this weapon.
/// </summary>
[RegisterComponent]
public sealed partial class ParticleOnMeleeAttackOtherComponent : ParticleOnEventBase;

/// <summary>
/// Spawns a particle effect on this entity when it is hit by a melee attack.
/// </summary>
[RegisterComponent]
...
/// <summary>
/// Spawns a particle effect when this entity lands after being thrown.
/// </summary>
[RegisterComponent]
public sealed partial class ParticleOnLandedComponent : ParticleOnEventBase;

/// <summary>
/// Spawns a particle effect when this entity is primed/activated (timed explosives, etc.).
/// </summary>
[RegisterComponent]
public sealed partial class ParticleOnPrimedComponent : ParticleOnEventBase;

/// <summary>
/// Spawns a particle effect on the gun when it fires.
/// </summary>
[RegisterComponent]
...
/// <summary>
/// Spawns a particle effect on this projectile when it hits something.
/// </summary>
[RegisterComponent]
public sealed partial class ParticleOnProjectileHitComponent : ParticleOnEventBase;

/// <summary>
/// Spawns a particle effect on whatever this projectile hits.
/// </summary>
[RegisterComponent]
