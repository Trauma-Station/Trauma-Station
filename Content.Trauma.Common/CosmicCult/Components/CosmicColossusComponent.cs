...
public sealed partial class CosmicColossusComponent : Component
{
    ...
    [DataField] public SoundSpecifier ReawakenSfx = new SoundPathSpecifier("/Audio/_Trauma/CosmicCult/colossus_spawn.ogg");

    [DataField] public SoundSpecifier DeathSfx = new SoundPathSpecifier("/Audio/_Trauma/CosmicCult/colossus_death.ogg");

    [DataField] public SoundSpecifier IngressSfx = new SoundPathSpecifier("/Audio/_Trauma/CosmicCult/ability_ingress.ogg");

    [DataField] public SoundSpecifier DoAfterSfx = new SoundPathSpecifier("/Audio/Machines/airlock_creaking.ogg");

    [DataField] public SoundSpecifier SunderSfx = new SoundPathSpecifier("/Audio/_Trauma/CosmicCult/ability_sunder.ogg");

    [DataField] public SoundSpecifier DissolveSfx = new SoundPathSpecifier("/Audio/_Trauma/CosmicCult/ability_lapse.ogg");
