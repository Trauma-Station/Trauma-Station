...
public sealed partial class MonumentComponent : Component
{
    ...
    [DataField]
    public SoundSpecifier BufferMusic = new SoundPathSpecifier("/Audio/_Trauma/CosmicCult/premonition.ogg")
    {
        Params = AudioParams.Default.WithVolume(-4f)
    };

    [DataField]
    public SoundSpecifier BufferMusicLoop = new SoundPathSpecifier("/Audio/_Trauma/CosmicCult/premonition_loop.ogg")
    {
        Params = AudioParams.Default.WithVolume(-4f).WithLoop(true)
    };

    [DataField]
    public SoundSpecifier FinaleMusic = new SoundPathSpecifier("/Audio/_Trauma/CosmicCult/a_new_dawn.ogg")
    {
        Params = AudioParams.Default.WithVolume(-4f)
    };
    ...
    [DataField]
    public SoundSpecifier SacrificeSfx = new SoundPathSpecifier("/Audio/_Trauma/CosmicCult/ability_blank.ogg");
}
