...
public sealed partial class CosmicChantryComponent : Component
{
    ...
    [DataField] public SoundSpecifier ChantryAlarm = new SoundPathSpecifier("/Audio/_Trauma/CosmicCult/chantry_alarm.ogg");

    [DataField] public SoundSpecifier BriefingSfx = new SoundPathSpecifier("/Audio/_Trauma/CosmicCult/antag_cosmic_AI_briefing.ogg");
