...
public sealed partial class CosmicCultistComponent : Component
{
    ...
    [DataField]
    public SoundSpecifier IngressSFX = new SoundPathSpecifier("/Audio/_Trauma/CosmicCult/ability_ingress.ogg");

    [DataField]
    public SoundSpecifier GlareSFX = new SoundPathSpecifier("/Audio/_Trauma/CosmicCult/ability_glare.ogg");

    [DataField]
    public SoundSpecifier NovaCastSFX = new SoundPathSpecifier("/Audio/_Trauma/CosmicCult/ability_nova_cast.ogg");

    [DataField]
    public SoundSpecifier ImpositionSFX = new SoundPathSpecifier("/Audio/_Trauma/CosmicCult/ability_imposition.ogg");
    [DataField]
    public SoundSpecifier TransmuteSFX = new SoundPathSpecifier("/Audio/_Trauma/CosmicCult/glyph_trigger.ogg");
    public SoundSpecifier StrideSFX = new SoundPathSpecifier("/Audio/_Trauma/CosmicCult/ability_stride.ogg");
    #endregion
}
