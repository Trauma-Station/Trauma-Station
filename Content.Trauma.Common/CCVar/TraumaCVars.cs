...
public sealed partial class TraumaCVars
{
    ...
    /// <summary>
    /// If false, area echoes calculate with 4 directions (NSEW).
    /// Otherwise, area echoes calculate with all 8 directions.
    /// </summary>
    /// <seealso cref="AreaEchoSystem"/>
    ...
    /// <summary>
    /// Distance interval, in tiles, for rays used to calculate roofs of an open area for echoes,
    /// or the ray's distance to space at which the tile is processed.
    ///
