...
namespace Content.Shared.GameTicking
{
    public abstract partial class SharedGameTicker : EntitySystem
    {
        ...
        public static readonly ProtoId<JobPrototype> FallbackOverflowJob = "DClass";  //Trauma Change: Changed overflow role from passenger to d-class

        //Trauma Change: Changed overflow role from passenger to d-class
