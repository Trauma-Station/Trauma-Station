...
{
    /// <summary>
    /// Can light go through the container of this ItemSlot?
    /// </summary>
    [DataField]
    ...
    /// <summary>
    /// if specified, doesn't insert the item instantly, but instead after a do-after passes.
    /// </summary>
    [DataField]
    [Access(typeof(ItemSlotsSystem), Other = AccessPermissions.ReadWriteExecute)]
    ...
    /// <summary>
    /// if specified, doesn't remove the item instantly, but instead after a do-after passes.
    /// </summary>
    [DataField]
    [Access(typeof(ItemSlotsSystem), Other = AccessPermissions.ReadWriteExecute)]
