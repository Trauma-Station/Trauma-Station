...
/// </summary>
[RegisterComponent, NetworkedComponent, AutoGenerateComponentState(true, fieldDeltas: true)] // Trauma - use deltas for each field
public sealed partial class SpriteMovementComponent : Component
{
    ...
    /// </summary>
    [DataField]
    [AutoNetworkedField] // Trauma - borg changes this
