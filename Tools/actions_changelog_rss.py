...
SSH_HOST = "ronstation-changelog"
SSH_USER = "ss14"
SSH_PORT = 22
RSS_FILE = "changelog.xml"
XSL_FILE = "stylesheet.xsl"
HOST_KEYS = [
    "AAAAC3NzaC1lZDI1NTE5AAAAIHrLmED/odCUqqfLu5e8jRTzLhrAtdlJdrxqdF+o8h+T"
]

# RSS feed parameters, change these
FEED_TITLE       = "RonStation Changelog"
FEED_LINK        = "https://github.com/RonStation/R.O.N.-Station"
FEED_DESCRIPTION = "Changelog for the official RonStation fork of SS14."
FEED_LANGUAGE    = "en-US"
FEED_GUID_PREFIX = "ss14-changelog-ronstation-"
FEED_URL         = "https://changelog.ronstation.space/changelog.xml"
