...
public sealed partial class SurgeryPrototype : IPrototype
{
    ...
    /// <summary>
    /// Components required on target part to perform surgery.
    /// </summary>
    [DataField]
    public ComponentRegistry? Required;

    /// <summary>
    /// Components that block surgery (e.g., OpenIncision).
    /// </summary>
    [DataField]
    public ComponentRegistry? Forbidden;
