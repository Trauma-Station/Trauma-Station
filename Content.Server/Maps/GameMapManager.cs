...
public sealed class GameMapManager : IGameMapManager
{
    ...
    {
        return map.MinPlayers >= _playerManager.PlayerCount && // Trauma - swap min and max to fix maps never being eligible
               map.MaxPlayers <= _playerManager.PlayerCount && // Trauma
